...
const en: Dict = {
  ...
  "nav.purchase_order_payment_charges": "Charges & Expenses",
...
const ps: Dict = {
  ...
  "nav.management": "مدیریت",
  "nav.goods_master": "د توکو فهرست",
  "nav.template_color": "تمپلېټ رنګ",
  "auth.welcome_back": "ښه راغلاست",
  "auth.sign_in_continue": "خپل اکاونټ ته د دوام لپاره ننوزئ",
  "auth.user_id_or_email": "یوزر آی ډي / ایمیل",
  "auth.password": "پاسورډ",
  "auth.remember_me": "ما یاد وساته",
