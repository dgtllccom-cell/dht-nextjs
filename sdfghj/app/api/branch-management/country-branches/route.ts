...
const countryBranchSelect =
  "id,country_id,name,code,local_currency,is_main,status,state_province_id,city_id,address,phone,email,company_id,owner_name,contacts,documents,permission_template,permission_grants,created_at,updated_at";

const countryBranchFallbackSelect =
  "id,country_id,name,code,local_currency,is_main,status,state_province_id,city_id,address,phone,email,company_id,owner_name,contacts,documents,created_at,updated_at";
