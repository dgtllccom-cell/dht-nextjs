-- Fix main branch roznamcha scope for purchase order payments
-- And fix post_roznamcha_entry to handle main_branch ledger scope
...
values ('0052_fix_roznamcha_main_branch_scope', 'applied')
