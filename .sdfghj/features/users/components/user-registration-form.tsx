...
export function UserRegistrationForm() {
  ...
  const requiresMainBranch = role === "main_branch_admin" || (role !== "super_admin" && role !== "country_admin");
  const requiresCityBranch =
    role !== "super_admin" && role !== "country_admin" && role !== "main_branch_admin" && role !== "auditor_viewer";
