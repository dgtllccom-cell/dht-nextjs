    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            roles: ["super_admin", "country_admin", "main_branch_admin", "city_branch_admin", "auditor_viewer"]
          }
        ]
      },
      {
        key: "new-account-entry",
        labelKey: "nav.new_account",
        iconKey: "book-open",
        children: [
          {
            key: "account-super-admin",
            labelKey: "nav.super_admin_account_entry",
            href: "/dashboard/new-entry/accounts/super-admin" as Route,
            roles: ["super_admin"]
          }
        ]
      }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        roles: ["super_admin", "country_admin", "main_branch_admin", "city_branch_admin", "accountant", "auditor_viewer"]
      }
    ]
  },
      {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            labelKey: "nav.exchange_rate_report",
