            ...
            <div className="relative">
              ...
              {actionsOpen ? (
                <div className="absolute right-0 z-20 mt-1 w-44 rounded-xl border bg-popover p-1 text-xs shadow-xl">
                  ...
                  <button className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-semibold hover:bg-muted" onClick={() => window.print()}><Printer className="h-3.5 w-3.5 text-blue-600" /> Print / PDF</button>
